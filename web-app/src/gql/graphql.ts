...
export type DeleteWilderMutation = { __typename?: 'Mutation', deleteWilder: { __typename?: 'Wilder', id: string, firstName: string, lastName: string } };
...
export type CreateWilderMutation = { __typename?: 'Mutation', createWilder: { __typename?: 'Wilder', id: string, firstName: string, lastName: string } };

export type GetWildersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetWildersQuery = { __typename?: 'Query', wilders: Array<{ __typename?: 'Wilder', id: string, firstName: string, lastName: string, isTrainer?: boolean | null, school?: { __typename?: 'School', id: string, schoolName: string } | null, skills: Array<{ __typename?: 'Skill', id: string, skillName: string }> }> };
